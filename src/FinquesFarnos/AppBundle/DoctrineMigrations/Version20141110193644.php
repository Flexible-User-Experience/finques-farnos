 ...
 */
class Version20141110193644 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__image AS SELECT id, image_name, meta_title, meta_alt, position, enabled, created_at, updated_at, deleted_at FROM image');
        ...
        $this->addSql('INSERT INTO image (id, image_name, meta_title, meta_alt, position, enabled, created_at, updated_at, deleted_at) SELECT id, image_name, meta_title, meta_alt, position, enabled, created_at, updated_at, deleted_at FROM __temp__image');
