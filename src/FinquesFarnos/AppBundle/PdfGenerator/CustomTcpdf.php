...
class CustomTcpdf extends \TCPDF
{
    ...
    public function Header()
    {
        ...
        $this->Image(__DIR__ . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . 'Resources' . DIRECTORY_SEPARATOR . 'public' . DIRECTORY_SEPARATOR . 'images' . DIRECTORY_SEPARATOR . 'logo-pdf-api.png', $this->getMargins()['left'] + 122, 10, 15, 0);
        $this->Image(__DIR__ . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . 'Resources' . DIRECTORY_SEPARATOR . 'public' . DIRECTORY_SEPARATOR . 'images' . DIRECTORY_SEPARATOR . 'logo-pdf-rm.png', $this->getMargins()['left'] + 141, 10, 40, 0);
    }
